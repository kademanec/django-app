...
from polls.views import productionList,materialsList,itemList,customerList,peopleList,inventoryList,salesList

# router = routers.DefaultRouter()
# router.register('purchase',views.purchaseList)
